import { APEX_BASE_URL, APEX_NETWORK, APEX_API_KEY, APEX_API_SECRET, APEX_API_PASSPHRASE, APEX_L2_KEY, DEFAULT_SYMBOL, DEFAULT_SYMBOL_DASH, APEX_SIGNER_URL } from '@env';
...
export function getEnv() {
  ...
  return {
    ...
    APEX_SIGNER_URL: APEX_SIGNER_URL || '',
