...
import type { GetUserSettingsUseCase } from '../../../../domain/settings/settings.usecases.js';
import { errorResponseSchema, resolveUserId, sendValidationError } from '../shared/http.js';
