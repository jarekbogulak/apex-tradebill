...
4. **Operator workflow** – invoked `curl GET /ops/apex-omni/secrets/status` with a dummy operator token; response echoed all four secret types and cache freshness timestamps.
